...
function filterByCurrentDate(data) {
    if (!Array.isArray(data)) {
        return data;
    }
...
export { filterToGet7DaysSchedule, filterByCurrentDate, prepareScheduleTableData, prepareLogTableData, formatDateTime, groupScheduleByJobId };